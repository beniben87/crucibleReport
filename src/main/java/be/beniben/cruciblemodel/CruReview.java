...
public class CruReview implements Serializable {
	...
	//bi-directional many-to-one association to CruInvitee
	@OneToMany(mappedBy="cruReview")
	private List<CruInvitee> cruInvitees;
	...
	public CruComment addCruComments1(CruComment cruComments1) {
		...
		cruComments1.setCruReview(this);
	...
	public CruComment removeCruComments1(CruComment cruComments1) {
		...
		cruComments1.setCruReview(null);
	...
	public List<CruInvitee> getCruInvitees() {
		return this.cruInvitees;
	}

	public void setCruInvitees(List<CruInvitee> cruInvitees) {
		this.cruInvitees = cruInvitees;
	}

	public CruInvitee addCruInvitee(CruInvitee cruInvitee) {
		getCruInvitees().add(cruInvitee);
		cruInvitee.setCruReview(this);

		return cruInvitee;
	}

	public CruInvitee removeCruInvitee(CruInvitee cruInvitee) {
		getCruInvitees().remove(cruInvitee);
		cruInvitee.setCruReview(null);
