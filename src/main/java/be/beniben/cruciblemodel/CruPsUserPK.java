...
/**
 * The primary key class for the CRU_PS_USER database table.
 * 
 */
@Embeddable
public class CruPsUserPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof CruPsUserPK)) {
			return false;
		}
		CruPsUserPK castOther = (CruPsUserPK)other;
		return 
