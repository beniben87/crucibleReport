...
/**
 * The primary key class for the CRU_PS_REVIEW_ROLE database table.
 * 
 */
@Embeddable
public class CruPsReviewRolePK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof CruPsReviewRolePK)) {
			return false;
		}
		CruPsReviewRolePK castOther = (CruPsReviewRolePK)other;
		return 
